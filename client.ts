...
export namespace auth {
    ...
    export class ServiceClient {
         ...
         * Logs in a user.
         */
        public async login(params: RequestType<typeof api_auth_users_login>): Promise<ResponseType<typeof api_auth_users_login>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/login`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_users_login>
        }
